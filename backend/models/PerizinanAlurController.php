...
/**
 * backend\models\PerizinanAlurController represents the model behind the search form about `backend\models\PerizinanAlur`.
 */
 class PerizinanAlurController extends PerizinanAlur
{
    /**
     * @inheritdoc
     */
